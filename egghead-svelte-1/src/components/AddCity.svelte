  ...
  <section class="main-card">
    ...
    <div class="city-search-wrapper">
      ...
      <div class="city-search-body">
        {#if showNote}
        <span class="city-invalid-note">City name is not valid. Note: only capital cities are supported for now</span>
        {/if}
        {#if cardCity}
        <app-weather-card city={cardCity}
      ...
      <div class="fav-city-body">
        <div class="fav-city-body-subwrapper">
          ...
          <div class="fav-weather-icon">
            ...
            {:else if state === 'Sunny' || state === 'Clear'}>
          ...
          <button class="fav-city-add-btn"
          class::fav-city-added-btn={followedCM}
          on:click={addCityOfTheMonth}
          disabled={followedCM}>{followedCM ? "FOLLOWED" : "FOLLOW"}</button>
        </div>
      </div>
